...
final class RxJava2WithProgressCallAdapter<R> implements CallAdapter<R, Object> {
  ...
  RxJava2WithProgressCallAdapter(Type responseType, Scheduler scheduler, boolean isAsync, boolean isResult,
